...
### Figure 1: Executions by Age Group Over Year
...
ggplot(dfplot_ages_years_all, aes(x = year, y = executions, color = age_group)) +
  ...
  scale_y_log10() +
  ggtitle("Figure 1: Executions by Age Group,  1800-1913") +
  xlab("Year") +
...
### Figure 2: Executions by Age Group Over Years (Males)
```{r figure_men}
...
ggplot(dfplot_men, aes(x = year, y = executions, color = age_group)) +
  geom_smooth(se = FALSE, method = "loess", size = 1.0) +
  scale_y_log10() +
  ggtitle("Figure 2: Executions by Age Group, 1800-1913 (Males)") +
  xlab("Year") +
  ylab("Number of Executions") +
  theme_minimal() +
  scale_color_manual(values = c("age_group_1_21" = "blue", "age_group_22_30" = "green", "age_group_31_50" = "red", "age_group_51_99" = "purple"), labels = c("1-21 years", "22-30 years", "31-50 years", "51-99 years")) +
...
### Figure 3: Executions by Age Group Over Years (Females)
```{r figure_women}
...
ggplot(dfplot_women, aes(x = year, y = executions, color = age_group)) +
  geom_smooth(se = FALSE, method = "loess", size = 1.0) +
  scale_y_log10() +
  ggtitle("Figure 3: Executions by Age Group, 1800-1913 (Females)") +
  xlab("Year") +
  ylab("Number of Executions") +
  theme_minimal() +
  scale_color_manual(values = c("age_group_1_21" = "blue", "age_group_22_30" = "green", "age_group_31_50" = "red", "age_group_51_99" = "purple"), labels = c("1-21 years", "22-30 years", "31-50 years", "51-99 years")) +
...
ggplot(dfplot_punish, aes(x = year, y = punish_amount, color = punish_type)) +
  geom_smooth(se = FALSE, method = "loess", size = 1.0) +
  scale_y_log10() +
  ggtitle("Figure 4: Punishments Over Years, 1800-1913") +
  xlab("Year") +
  ylab("Punishment prevelance") +
  theme_minimal() +
  scale_color_manual(
...
ggplot(dfplot_offence, aes(x = year, y = offence_amount, color = offence_category)) +
  geom_smooth(se = FALSE, method = "loess", size = 1.0) +
  scale_y_log10() +
  ggtitle("Figure 5: Offences committed by individuals sentenced to death, 1800-1913") +
  xlab("Year") +
  ylab("Offence Prevalence") +
  theme_minimal() +
  scale_color_manual(
  ...
  labels = c("breakingPeace" = "Breaking peace", "deception" = "Deception", "kill" = "Murder", "miscellaneous" = "Miscellaneous", "royalOffences" = "Royal Offences", "theft" = "Theft", "violentTheft" = "Violent Theft", "sexual" = "Sexual", "damage" = "Damage")) +
